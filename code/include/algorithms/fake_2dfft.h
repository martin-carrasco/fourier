...
dfft_arg<float> dfft1d_gpu_glready(const dfft_arg<float>& xi,
                                   const dfft_dir& dir);
dfft_arg<float> dfft2d_gpu_glready(const dfft_arg<float>& xi,
                                   const dfft_dir& dir);
dfft_arg<float> dfft3d_gpu_glready(const dfft_arg<float>& xi,
                                   const dfft_dir& dir);
